...
import type { DeadLinkResult, DeadLinkDetectionProgress } from '../domain/deadLinkDetection';
import { detectDeadLinks } from '../domain/deadLinkDetection';
import { simplifyUrl } from '../shared/utils';
